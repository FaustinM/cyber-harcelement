...
function gilet(){
    ...
    setTimeout(async ()=>{
        addInfo("Si vous likez ces blagues votre avenir changera...", false)
    ...
    setTimeout(()=>{
        addPosts("maude", "Super drole vos blauges 😂😂😂", rand(22), rand(8), rand(9), getHeure(), ()=>{
            localStorage.setItem("position", "likeBlagueDebut");
        })
    }, 8000);
    setTimeout(()=>{
